...
import AqlTable from './AqlTable.vue';
...
export default {
  install(app) {
    ...
    app.component('os-aql-table',        AqlTable);
    ...
    app.component('os-dynamic-menu',     DynamicMenu);
    app.component('os-dynamic-template', DynamicTemplate);
